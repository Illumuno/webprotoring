...
<link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/4.7.0/css/font-awesome.min.css">
 ...
 <!--styles -->
    ...
    <link href="{{asset('js/owl.carousel.css')}}" rel="stylesheet">
    <link href="{{asset('js/owl.theme.default.css')}}" rel="stylesheet">
...
<div id="main" class="main">
  ...
  <div class="mb-3 card" style= "background: #eff2f7; border:none;">
  <div class="row g-0">
  <div  id="c1">
    <div class="col-md-3">
